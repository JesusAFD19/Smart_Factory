...
##########  MQTT Topics  ##########
topic1 = "/R0_flag2"         #subscriber
topic2 = "/home2"           #publisher
topic3 = "/zero2"                  #publisher
topic0 = "/recepcion2"
topic4 = "/pick_routine2"
...
def routine(routine_no):
    ...
    for i in positions:
        ...
        r1_information_t = "1,"+str(i[0]) + ","+str(i[1]) + ","+str(i[2]) + ","+str(i[3]) + ","+str(i[4]) + ","+str(i[5]) + ","+str(i[6]) + ","+str(routine_no) + "," + str(time_stamp)        
...
def routine_pick():
    ...
    arm.pump_off()
    sleep(1)
    arm.go_to_axis(53,51.4,-9.6,0,-46.7,-13.2,0)
    sleep(1)
    arm.pump_on()
    sleep(1)
    arm.go_to_axis(53,29.9,-26.7,0,-8.1,-13.2,0)
    sleep(1)
    arm.go_to_axis(0,0,0,0,0,0,0)
    sleep(1)
    arm.go_to_axis(0,40.8,20.6,0,-66.5,0)
    sleep(1)
    arm.pump_off()
    sleep(1)
    arm.go_to_axis(0,0,0,0,0,0,0)
